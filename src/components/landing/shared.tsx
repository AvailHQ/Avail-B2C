...
export const sectionSub = 'type-lead mx-auto max-w-[540px] text-[#4F5B60]';
export const labelClass = 'type-caption font-extrabold uppercase tracking-[1.5px] text-[#1F6E92]';
